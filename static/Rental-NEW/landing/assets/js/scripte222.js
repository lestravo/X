!function(a) {
    ...
    var T = a(".promo-trigger"),
        S = a(".promo-content"),
        B = a(".promo-close");
    B.length > 0 && B.on("click", function() {
        var a = Cookies.get("twz-offer");
        return S.removeClass("active"), T.addClass("active"), null === a && Cookies.set("twz-offer", "true", {
            expires: 1,
            path: ""
        }), !1
    }), l.on("load", function() {
        null === Cookies.get("twz-offer") ? S.addClass("active") : T.addClass("active")
    });
    var F = e.hasClass("is-rtl") ? "../../images" : "../images",
        M = e.hasClass("is-rtl") ? "../../rtl/" : "../",
        O = e.hasClass("is-rtl") ? "../../../ico-user/" : "../../ico-user/",
        _ = e.hasClass("is-rtl") ? "../" : "./rtl/",
        H = e.hasClass("is-rtl") ? "LTR" : "RTL";
    var G = a(".demo-themes,.demo-close"),
        N = a(".demo-content"),
        R = a(".demo-color-toggle"),
        U = a(".demo-color"),
        J = a(".color-trigger");
    N.length > 0 && G.on("click", function() {
        N.toggleClass("demo-active").css("display", "block"), e.toggleClass("shown-preview")
    ...
    if (Q.length > 0 || W.length > 0) {
        ...
        if (Q.length > 0) {
            var q = Q.find("select.required"),
                Z = Q.find(".form-results");
            Q.validate({
